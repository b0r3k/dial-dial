...
extrakce významu (\ref{nlu}), zachování stavu (\ref{dst}), rozhodnutí o dalším kroku (\ref{dp}),
...
\subsection{Zachování stavu}\label{dst}
...
překvapivě dobře. Dalšími možnostmi je použít formálních gramatik \citep{teich_grammars_1999}
či i zde strojového učení \citep{wen_stochastic_2015}.
...
Mezi další využívané přístupy patří opět využití HMM a jiných modelů strojového učení. Modely
